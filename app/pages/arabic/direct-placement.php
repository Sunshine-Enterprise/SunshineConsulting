                ...
                <div class="row" id="vacancy-container">
                    ...
                    <div class="col-md-12 rounded py-5" id="category-vacancy">
                        ...
                        <div class="row" id="job-row">
                                <h2 class="display-5 fw-bold py-2">التنسيب المباشر</h2>
                        </div>
                    ...
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                            <img class="img-fluid rounded" src="assets/direct.jpg">
                            </div>

                            <div class="col-sm-6">
                                <img class="img-fluid rounded" src="assets/direct1.jpg">
                            </div>
                    ...
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                            <img class="img-fluid rounded" src="assets/direct2.jpg">
                            </div>

                            <div class="col-sm-6">
                                <img class="img-fluid rounded" src="assets/direct3.jpg">
                            </div>
