        ...
        <section class="pb-5">
                ...
                <div class="row" id="vacancy-container">
                    ...
                    <div class="col-md-12 rounded py-5" id="category-vacancy">
                        ...
                        <div class="row" id="job-row">
                                <h2 class="display-5 fw-bold py-2">خدمات الإدارة </h2>
                        </div>
			...
			<div class="col-md-4 py-2 py-md-2">
				<div class="bg-light mb-5 mb-md-0 p-2 p-lg-5 text-center position-relative">
					<img alt="" class=" position-absolute translate-middle top-0" height="96" src="assets/management1.jpg" >
			...
			<div class="col-md-4 py-2 py-md-2">
				<div class="bg-light mb-5 mb-md-0 p-2 p-lg-5 text-center position-relative">
					<img alt="" class="position-absolute translate-middle top-0" height="96" src="assets/management.jpg" >
					<div class="text-primary mb-md-4 mb-2 mt-5 mt-lg-4">
			...
			<div class="col-md-4 py-2 py-md-2">
				<div class="bg-light mb-5 mb-md-0 p-2 p-lg-5 text-center position-relative">
					<img alt="" class="position-absolute translate-middle top-0" height="96" src="assets/management3.jpg">
					<div class="text-primary mb-md-4 mb-2 mt-5 mt-lg-4">
