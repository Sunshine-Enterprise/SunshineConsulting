               ...
               <!-- <a class="navbar-brand" href="home">SCGCC</a> -->
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="vacancies">الشواغر</a></li>
                        <li class="nav-item"><a class="nav-link" href="team">فريق</a></li>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item rounded text-center mx-1">
                            <a href="home">
                                <button type="button" class="btn btn-primary" id="language">إن</button>
                            </a>
                        </li>
                        
                        <li class="nav-item rounded text-center mx-1">
                            <a href="home.ar">
                                <button type="button" class="btn btn-primary" id="language">عربي</button>
                            </a>
                        </li>
